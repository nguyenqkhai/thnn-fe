    ...
    <footer className="bg-gray-800 text-white py-6 mt-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="text-center md:text-left">
            ...
            <div className="flex space-x-4 justify-center md:justify-start">
              ...
              <a href="#" className="text-gray-400 hover:text-white transition-colors duration-300">
                ...
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                  <path fillRule="evenodd" d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943-.359.09-.627.402-.627.754v2.27c0 .26.18.516.553.516 3.973-1.322 6.839-5.077 6.839-9.501C22 6.484 17.522 2 12 2z" clipRule="evenodd" />
                </svg>
              </a>
            </div>
          </div>
          ...
          <div className="text-center md:text-left">
            <h3 className="text-lg font-bold mb-3">Liên Kết Hữu Ích</h3>
            <ul className="space-y-2">
              <li>
                <Link to="/danh-sach-bai" className="text-gray-400 hover:text-white transition-colors duration-300">
                  Danh sách bài tập
                </Link>
              </li>
              <li>
                <Link to="/cac-bai-da-nop" className="text-gray-400 hover:text-white transition-colors duration-300">
                  Bài tập đã nộp
                </Link>
              </li>
              <li>
                <Link to="/cac-ky-thi" className="text-gray-400 hover:text-white transition-colors duration-300">
                  Các kỳ thi
                </Link>
              </li>
              {/* <li>
